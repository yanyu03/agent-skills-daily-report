# Cloudflare 账号与部署链补充审计

## 当前 Token 可见的 Zone

- **可见 Zone 数量：** 0
- 当前 API Token 在此 Account ID 下看不到任何 Zone。
- **是否包含 `250221.xyz`：** 否
...
- `31122435799`：event=`workflow_run`，branch=`main`，status=`completed`，conclusion=`skipped`，created=`2026-08-06T17:12:18Z`，updated=`2026-08-06T17:12:20Z`
...
- `31060025350`：event=`workflow_run`，branch=`main`，status=`completed`，conclusion=`success`，created=`2026-08-06T00:32:25Z`，updated=`2026-08-06T00:32:56Z`
- `31059760726`：event=`workflow_run`，branch=`main`，status=`completed`，conclusion=`success`，created=`2026-08-06T00:27:24Z`，updated=`2026-08-06T00:27:56Z`

### 最新运行任务

- **从 blog 分支发布静态站点：** status=`completed`，conclusion=`skipped`
